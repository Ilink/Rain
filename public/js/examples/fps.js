...
SimpleFullscreenControl.prototype.fullscreenChange = function () {
    if (document.webkitFullscreenElement === this.element || document.mozFullscreenElement === this.element || document.mozFullScreenElement === this.element) {
...
SimpleFullscreenControl.prototype.enterFullscreen = function () {
    this.element.requestFullscreen = this.element.requestFullscreen || this.element.mozRequestFullscreen || this.element.webkitRequestFullscreen;
...
SimplePointerLockControl.prototype.pointerLockChange = function () {
    if (document.mozPointerLockElement === this.element || document.webkitPointerLockElement === this.element) {
...
FPSController.prototype.prepare = function () {
    ...
    this.webGL.shaderSource(this.gridVertexShader, '' + 'precision highp float;' + 'attribute vec3 vPosition;' + 'attribute vec4 vColor;' + 'uniform mat4 cameraTransform;' + 'varying vec4 fColor;' + 'void main() {' + 'fColor = vColor;' + 'vec4 vPosition4 = vec4(vPosition.x, vPosition.y, vPosition.z, 1.0);' + 'gl_Position = cameraTransform*vPosition4;' + '}');
    ...
    this.webGL.shaderSource(this.gridFragmentShader, '' + 'precision mediump float;' + 'varying vec4 fColor;' + 'void main() {' + 'gl_FragColor = fColor;' + '}');
...
addView = function (canvasId, moveEnabled, yawEnabled, pitchEnabled) {
    ...
    window.requestAnimationFrame(function (t) {
        canvasElement.controller.animateCallback(t);
    });
    ...
    canvasElement.controller.pointerLockControl.lockHook = function (e) {
        canvasElement.controller.lockHook(e);
    };
    canvasElement.controller.pointerLockControl.unlockHook = function (e) {
        canvasElement.controller.unlockHook(e);
    };
    canvasElement.controller.pointerLockControl.pointerMoveHook = function (x, y) {
        canvasElement.controller.moveHook(x, y);
    };
    canvasElement.addEventListener('click', function (e) {
        canvasElement.controller.clickHook(e);
    }, false);
